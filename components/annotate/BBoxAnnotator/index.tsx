            ...
            >
                ...
                {entries.map((entry, i) => (
                    ...
                    >
                        ...
                        {selectedId === entry.id ? (
                            <>
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', top: '-5px', left: '-5px', cursor: 'nwse-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 'nw', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', top: '-5px', left: '50%', transform: 'translateX(-50%)', cursor: 'ns-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 'n', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', top: '-5px', right: '-5px', cursor: 'nesw-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 'ne', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', top: '50%', right: '-5px', transform: 'translateY(-50%)', cursor: 'ew-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 'e', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', bottom: '-5px', right: '-5px', cursor: 'nwse-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 'se', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', bottom: '-5px', left: '50%', transform: 'translateX(-50%)', cursor: 'ns-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 's', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', bottom: '-5px', left: '-5px', cursor: 'nesw-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 'sw', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                                <div style={{ position: 'absolute', width: '8px', height: '8px', background: '#fff', border: '1px solid #007bff', top: '50%', left: '-5px', transform: 'translateY(-50%)', cursor: 'ew-resize' }}
                                    onMouseDown={(e) => { e.stopPropagation(); const pos = crop(e.pageX, e.pageY); setResizing({ id: entry.id, handle: 'w', startX: pos.x, startY: pos.y, startRect: { left: entry.left, top: entry.top, width: entry.width, height: entry.height } }); }} />
                            </>
                        ) : null}
